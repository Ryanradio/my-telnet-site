...
const WEAPONS = {
    ...
    // ═══════════════════════════════════════════════════════════════
    // RUNESMITH WEAPONS — War Picks & Mattocks
    // Hybrid physical/magic. allowedClasses: ['runesmith'] only.
    // ═══════════════════════════════════════════════════════════════
    chipped_mattock: {
        "name": "Chipped Mattock",
        "baseDamage": 7,
        "maxDamage": 12,
        "baseMagicDamage": 2,
        "cost": 0,
        ...
        "weaponSubtype": "mattock",
        "description": "A battered mining tool, hastily etched with a crude rune. Still hits hard."
    },
    rune_pick: {
        "name": "Rune Pick",
        "baseDamage": 9,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "pick",
        "description": "Iron pick etched with a basic power rune. Channels arcane force through each blow."
    },
    stonecleave: {
        "name": "Stonecleave",
        "baseDamage": 13,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "mattock",
        "description": "Heavy mattock that splits both stone and spell-ward alike."
    },
    forgehammer_rune: {
        "name": "Forgehammer",
        "baseDamage": 18,
        ...
        "description": "Dwarf-forged war hammer. The runes on its face glow faintly when charged."
    },
    earthshatter: {
        "name": "Earthshatter",
        "baseDamage": 24,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "mattock",
        "description": "When it strikes, the ground remembers."
    },
    runevein_pick: {
        "name": "Runevein Pick",
        "baseDamage": 30,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "pick",
        "description": "Veins of glowing runestone run through the steel. Overload strikes vaporize armor."
    },
    deepstone_maul: {
        "name": "Deepstone Maul",
        "baseDamage": 38,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "hammer",
        "description": "Carved from a single block of deepstone ore. The runes were already in the rock."
    },
    inscription_pick: {
        "name": "Inscription Pick",
        "baseDamage": 47,
        "maxDamage": 70,
        "baseMagicDamage": 34,
        "cost": 14000,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "pick",
        "description": "Every swing inscribes a killing rune directly onto the enemy."
    },
    vaultbreaker: {
        "name": "Vaultbreaker",
        "baseDamage": 58,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "mattock",
        "description": "Broke the Vault of Kor'dan. The runes on its head haven't cooled since."
    },
    anvilborn: {
        "name": "Anvilborn",
        "baseDamage": 70,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "hammer",
        "description": "Said to have been born from a god's anvil, not forged upon one."
    },
    ruinpick: {
        "name": "Ruinpick",
        "baseDamage": 85,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "pick",
        "description": "Built to unmake fortresses. Turns out it unmakers anything."
    },
    worldseam_mattock: {
        "name": "Worldseam Mattock",
        "baseDamage": 100,
        "maxDamage": 150,
        "baseMagicDamage": 78,
        "cost": 70000,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "mattock",
        "description": "Etched along the seam of the world itself. Overload tears reality slightly."
    },
    godpick: {
        "name": "Godpick",
        "baseDamage": 120,
        ...
        "allowedClasses": ["runesmith"],
        "weaponSubtype": "pick",
        "description": "The gods forged it, then hid it. You found it anyway."
    }
};
