...
const EXPLORATION_ZONES = {
    ...
    forest: {
        ...
        enemyLevelRange: [1, 3],
        encounters: ['goblin', 'wolf', 'giant_spider', 'wild_boar', 'slime', 'kobold', 'giant_rat', 'forest_imp'],
        requiredLevel: 1,
        locked: false,
        town: 'town1',
    ...
    haunted_graveyard: {
        ...
        enemyLevelRange: [7, 9],
        encounters: ['zombie', 'ghoul', 'skeleton', 'grave_robber'],
        requiredLevel: 7,
        locked: true,
        town: 'town1',
    ...
    dark_swamp: {
        ...
        encounters: ['swamp_hag', 'plague_zombie', 'giant_leech', 'bog_beast'],
        requiredLevel: 10,
        locked: true,
        town: 'town2',
